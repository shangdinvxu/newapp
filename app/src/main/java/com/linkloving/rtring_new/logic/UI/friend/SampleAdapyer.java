...
import com.linkloving.rtring_new.logic.UI.personal.EntInfoActivity;
...
public class SampleAdapyer extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View foot_view=mInflater.inflate(R.layout.qunzunhead,parent,false);
    ...
    public static class FootViewHolder extends  RecyclerView.ViewHolder{
        ...
        public FootViewHolder(View view) {
            super(view);
            ent_linearlayout= (RelativeLayout) view.findViewById(R.id.linearLayout_ent_follw);
            name=(TextView)view.findViewById(R.id.ent_name);
//            what_up=(TextView)view.findViewById(R.id.ent_whatsup);
            head= (ImageView) view.findViewById(R.id.ent_head);
        }
    }
    //添加数据
